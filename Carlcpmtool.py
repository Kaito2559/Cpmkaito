...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{31}:  3second glitch          6.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{32}: Custom Car Brake         2.000'))
            print(Colorate.Horizontal(Colors.rainbow, '{0} : Exit'))
            
            print(Colorate.Horizontal(Colors.rainbow, '===============[ 𝐂𝐀𝐑𝐋𝐂𝐏𝐌𝐓𝐎𝐎𝐋𝐕2]==============='))
            ...
            if service == 0: # Exit
                ...
                if cpm.set_player_rank():
                    ...
                    print(Colorate.Horizontal'('Colors.r