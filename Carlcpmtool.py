...
def load_key_data(cpm):
    ...
    print(Colorate.Horizontal(Colors.green, Center.XCenter('===============================[ 𝖠𝖢𝖢𝖤𝖲𝖲 𝖪𝖤𝖸 𝖣𝖤𝖳𝖠𝖨𝖫𝖲 ]===============================')))
    
    print(Colorate.Horizontal(Colors.green, Center.XCenter(f'Access Key: {data.get("access_key")} <> Telegram ID: {data.get("telegram_id")} <> Balance: {(data.get("coins") if not data.get("is_unlimited") else "Unlimited")}')))
...
def prompt_valid_value(content, tag, password=False):
    while True:
        ...
        if not value or value.isspace():
            print(Colorate.Horizontal(Colors.blue, f'{tag} cannot be empty or just spaces. Please try again.'))
        else:
            return value
...
def load_client_details():
    ...
    data = response.json()
    print(Colorate.Horizontal(Colors.blue, Center.XCenter('===============================[ 𝖫𝖮𝖢𝖠𝖳𝖨𝖮𝖭 ]===============================')))
    print(Colorate.Horizontal(Colors.blue, Center.XCenter(f'Country: {data.get("country")} <> Region: {data.get("regionName")} <> City: {data.get("city")}')))
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                if cpm.set_player_rank():
                    ...
                    print(Colorate.Horizontal(Colors.blue, '======================================'))
                    answ = Prompt.ask("[?] Do You want to Exit ?", choices=["y", "n"], default="n")
                    if answ == "y": print(Colorate.Horizontal(Colors.rainbow, f'Thank You for using our tool, 